...
title('Probability of Being Within a Damage State')
grid on
set(gca, ...
  'Box'         , 'off'     , ...
  'TickDir'     , 'out'     , ...
...
legend('Total','No Collapse','Collapse','Location','northwest')
...
title('Standard Deviation of EDP')
xlabel('Sa (g)')
ylabel('Median IDR')
legend('Story 5','Story 4', 'Story 3', 'Story 2', 'Story 1','Location','southeast')
grid on
set(gca, ...
  'Box'         , 'off'     , ...
  'TickDir'     , 'out'     , ...
